...
-   You can follow along [here](https://github.com/suyoghc/PSY-504_Spring-2025/blob/main/Poisson%20Regression/Poisson.qmd)
...
```{webr-r}
hh_data <- read.csv("https://raw.githubusercontent.com/suyoghc/PSY-504_Spring-2025/refs/heads/main/Poisson%20Regression/data/tobii_aoi_study1.csv")
```
